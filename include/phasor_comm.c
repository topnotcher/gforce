...
comm_driver_t * phasor_comm_init(chunkpool_t * chunkpool, uint8_t mpc_addr, void (*end_rx)(comm_driver_t*)) {
	comm_dev_t * commdev;
	...
	return comm_init( commdev, mpc_addr, MPC_PKT_MAX_SIZE, chunkpool, end_rx);
}
